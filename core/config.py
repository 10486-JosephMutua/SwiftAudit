...
class Config:
    ...
    SNYK_TIMEOUT: int = int(os.getenv("SNYK_TIMEOUT", "12000"))

    # Trivy — allow enough time for DB init on first run
    TRIVY_TIMEOUT: int     = int(os.getenv("TRIVY_TIMEOUT", "30000"))
    ...
    # Repo / clone
    GIT_CLONE_TIMEOUT: int = int(os.getenv("GIT_CLONE_TIMEOUT", "6000"))
